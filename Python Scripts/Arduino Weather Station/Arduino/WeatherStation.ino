...
#define WIFI_SSID "Basement Networks"
#define WIFI_PASS "regan012"
...
unsigned long channelID = 2445470; // Replace with your ThingSpeak Channel ID
const char *apiKey = "WFK9KAGKB4WGKPV8"; // Replace with your ThingSpeak Write API Key
